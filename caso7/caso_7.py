...
for k in range(int32(Days/dt)):
    ...
    ambiente = 20. + 10*(np.sin((2*3.14/T)*t))
    # CB esenciales, se repiten en cada iteracion
    u_k[0, :] = u_k[1,:] - 0*dx        #izq
...
plot(t_evolucion, T_ambiente, '--',label='T° ambiente', color='black')
...
savefig(f"caso7/Grafico_Evolucion_caso7.png")
show()
